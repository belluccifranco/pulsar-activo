...
!function(){"use strict";angular.module("pulsarActivoManager",["ngRoute","ngResource","uiGmapgoogle-maps"]).config(["uiGmapGoogleMapApiProvider",function(uiGmapGoogleMapApiProvider){uiGmapGoogleMapApiProvider.configure({libraries:"weather,geometry,visualization"})}]).config(["$routeProvider","$locationProvider",function($routeProvider){$routeProvider.when("/",{templateUrl:"templates/main.html",controller:"mainController"})}])}(),function(){"use strict";angular.module("pulsarActivoManager").controller("mainController",function($scope,uiGmapGoogleMapApi){$scope.map={center:{latitude:40.1451,longitude:-99.668},zoom:4},uiGmapGoogleMapApi.then(function(){})})}();